...
function TimelineMap({
  ...
  return (
    ...
    /* @__PURE__ */ React.createElement("div", { className: "timeline-map" }, /* @__PURE__ */ React.createElement(
      MapContainer,
      {
        zoom: 3,
        center: [0, 0],
      ...
      /* @__PURE__ */ React.createElement(MapFitter, { pins }),
      /* @__PURE__ */ React.createElement(FeatureGroup, null, pins.map((pin, index) => {
        const dt = DateTime2.fromISO(pin.date, { setZone: true });
        return /* @__PURE__ */ React.createElement(
          ...
          /* @__PURE__ */ React.createElement(Popup, { autoClose: false, closeButton: false, closeOnClick: false }, pin.isFrom ? /* @__PURE__ */ React.createElement("h1", null, pin.time.split(" ").pop(), /* @__PURE__ */ React.createElement("br", null), dt.toFormat("yyyy-MM-dd HH:mm")) : /* @__PURE__ */ React.createElement("h3", { onClick: () => handlePinClick(pin) }, pin.time.split(" ").pop(), /* @__PURE__ */ React.createElement("br", null), dt.toFormat("yyyy-MM-dd HH:mm")))
        );
      }))
    ))
  );
